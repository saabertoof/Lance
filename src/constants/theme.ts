...
const palette = {
  ...
  cyan: operatorVisual.cyan,
  cyanSoft: operatorVisual.cyanSoft,
  amber: operatorVisual.amber,
  amberSoft: operatorVisual.amberSoft,
  rose: operatorVisual.rose,
  roseSoft: operatorVisual.roseSoft,
...
export const theme = {
  colors: {
    ...
    accentCyanSoft: palette.cyanSoft,
